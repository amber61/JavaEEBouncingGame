 ...
 * Description: building blocks of applications
 * Date: April 15, 2017
 */
...
import com.enterpriseandroid.restfulsprites.svc.RESTService;
 ...
 * @version 1.0.0
 * @see android.annotation.TargetApi
 * @see android.content.ContentProvider
 * @see android.content.ContentUris
 * @see android.content.ContentValues
 * @see android.content.UriMatcher
 * @see android.database.Cursor
 * @see android.database.sqlite.SQLiteQueryBuilder
 * @see android.net.Uri
 * @see android.os.Build
 * @see android.util.Log
 * @see net.callmeike.android.data.util.ColumnMap
 * @see net.callmeike.android.data.util.ProjectionMap
 * @see com.enterpriseandroid.restfulsprites.BuildConfig
 * @see com.enterpriseandroid.restfulsprites.svc.RESTService
 * @since 1.8.0_73
 */
public class SpritesProvider extends ContentProvider {
    ...
    public int update(Uri uri, ContentValues vals, String sel, String[] sArgs) {
        ...
        if (!remoteSync) {
            ...
            if (null != xact) { vals.put(SpritesHelper.COL_SYNC, xact); }
        }
